...
ggplot()+
  geom_col(aes(x = year, y = late_summer_coho_population_abundance, fill = 'smolts(?)'),alpha=0.8, data = co) +
  geom_col(aes(x = year, y = population_estimate_n, fill = 'juveniles'), alpha=0.8, data = juv_co_s) + 
  scale_fill_paletteer_d("nationalparkcolors::Badlands") +
  # scale_fill_manual(values = c(coho_colour_values$values))
  # scale_fill_identity(guide = "legend") + 
  geom_vline(data = logging_changes, aes(xintercept = Year), lty = 2, alpha = 0.25) +
